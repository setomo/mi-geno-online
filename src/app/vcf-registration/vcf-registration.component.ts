...
@Component({
  selector: 'app-vcf-registration',
  templateUrl: './vcf-registration.component.html',
  styleUrls: ['./vcf-registration.component.css'],
})
export class VcfRegistrationComponent implements OnInit {
